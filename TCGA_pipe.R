...
TCGA.pipe(options$disease,wd="./Data",cores=detectCores()/2,permu.size=300,Pe=0.01,analysis = "all",
          diff.dir=options$diffdir,rm.chr=paste0("chr",c("X","Y")))
